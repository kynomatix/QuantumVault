...
export const LAB_AVAILABLE_TICKERS = [
  ...
  { symbol: "APT/USDT:USDT", name: "APT" },
  { symbol: "POL/USDT:USDT", name: "POL" },
  { symbol: "ARB/USDT:USDT", name: "ARB" },
  { symbol: "DOGE/USDT:USDT", name: "DOGE" },
  { symbol: "BNB/USDT:USDT", name: "BNB" },
  { symbol: "SUI/USDT:USDT", name: "SUI" },
  { symbol: "OP/USDT:USDT", name: "OP" },
  { symbol: "RENDER/USDT:USDT", name: "RENDER" },
  { symbol: "XRP/USDT:USDT", name: "XRP" },
  { symbol: "HNT/USDT:USDT", name: "HNT" },
  { symbol: "INJ/USDT:USDT", name: "INJ" },
  { symbol: "LINK/USDT:USDT", name: "LINK" },
  { symbol: "PYTH/USDT:USDT", name: "PYTH" },
  { symbol: "TIA/USDT:USDT", name: "TIA" },
  { symbol: "JTO/USDT:USDT", name: "JTO" },
  { symbol: "SEI/USDT:USDT", name: "SEI" },
  { symbol: "AVAX/USDT:USDT", name: "AVAX" },
  { symbol: "WIF/USDT:USDT", name: "WIF" },
  { symbol: "JUP/USDT:USDT", name: "JUP" },
  { symbol: "TAO/USDT:USDT", name: "TAO" },
  { symbol: "W/USDT:USDT", name: "W" },
  { symbol: "KMNO/USDT:USDT", name: "KMNO" },
  { symbol: "TNSR/USDT:USDT", name: "TNSR" },
  { symbol: "DRIFT/USDT:USDT", name: "DRIFT" },
  { symbol: "CLOUD/USDT:USDT", name: "CLOUD" },
  { symbol: "IO/USDT:USDT", name: "IO" },
  { symbol: "POPCAT/USDT:USDT", name: "POPCAT" },
  { symbol: "TON/USDT:USDT", name: "TON" },
  { symbol: "MOTHER/USDT:USDT", name: "MOTHER" },
  { symbol: "MOODENG/USDT:USDT", name: "MOODENG" },
  { symbol: "DBR/USDT:USDT", name: "DBR" },
  { symbol: "MEW/USDT:USDT", name: "MEW" },
  { symbol: "MICHI/USDT:USDT", name: "MICHI" },
  { symbol: "GOAT/USDT:USDT", name: "GOAT" },
  { symbol: "FWOG/USDT:USDT", name: "FWOG" },
  { symbol: "PNUT/USDT:USDT", name: "PNUT" },
  { symbol: "RAY/USDT:USDT", name: "RAY" },
  { symbol: "HYPE/USDT:USDT", name: "HYPE" },
  { symbol: "LTC/USDT:USDT", name: "LTC" },
  { symbol: "ME/USDT:USDT", name: "ME" },
