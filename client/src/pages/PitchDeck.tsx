  ...
  return (
    ...
    >
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 -left-32 w-64 h-64 bg-violet-500/[0.03] rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 -right-32 w-64 h-64 bg-indigo-500/[0.03] rounded-full blur-3xl" />
      </div>
...
function BusinessModelSlide() {
  return (
    <Slide>
      ...
      <motion.p variants={fadeIn} className="text-lg text-muted-foreground mb-6 text-center">
        Performance fees that scale with network growth
      </motion.p>
      
      <motion.div variants={fadeIn} className="grid grid-cols-5 gap-2 max-w-4xl w-full mb-6">
        <div className="p-4 rounded-xl bg-slate-700/20 border border-slate-600/30 text-center">
          ...
          <div className="text-xs text-white/70 mt-1 font-medium">Preview</div>
          <div className="text-[10px] text-muted-foreground mt-1">Dev Only</div>
        </div>
        <div className="p-4 rounded-xl bg-slate-600/20 border border-slate-500/30 text-center">
          <div className="text-2xl font-bold text-slate-300">0.1%</div>
          <div className="text-xs text-white/70 mt-1 font-medium">Bootstrapping</div>
          <div className="text-[10px] text-muted-foreground mt-1">0-100 users</div>
        </div>
        <div className="p-4 rounded-xl bg-indigo-900/30 border border-indigo-700/30 text-center">
          <div className="text-2xl font-bold text-indigo-300">0.3%</div>
          <div className="text-xs text-white/70 mt-1 font-medium">Sustainability</div>
          <div className="text-[10px] text-muted-foreground mt-1">101-200 users</div>
        </div>
        <div className="p-4 rounded-xl bg-violet-800/30 border border-violet-600/40 text-center">
          <div className="text-2xl font-bold text-violet-300">1.0%</div>
          <div className="text-xs text-white/70 mt-1 font-medium">Maturity</div>
          <div className="text-[10px] text-muted-foreground mt-1">201-300 users</div>
        </div>
        <div className="p-4 rounded-xl bg-violet-700/30 border border-violet-500/40 text-center">
          <div className="text-2xl font-bold text-violet-200">0.3%</div>
          <div className="text-xs text-white/70 mt-1 font-medium">Efficiency</div>
          <div className="text-[10px] text-muted-foreground mt-1">300+ floor</div>
        </div>
      </motion.div>
      
      <motion.div variants={fadeIn} className="p-4 rounded-xl bg-slate-800/50 border border-slate-700/50 max-w-md text-center">
        <div className="text-sm text-white/80 font-medium mb-1">Active User Definition</div>
        <div className="text-xs text-muted-foreground">At least 1 bot running in the last 30 days</div>
      </motion.div>
      
      <motion.p variants={fadeIn} className="text-xs text-violet-300/60 mt-4 text-center">
  ...
  return (
    <Slide className="text-center relative overflow-hidden">
      ...
      <motion.div variants={fadeIn} className="flex flex-wrap gap-6 justify-center text-sm text-muted-foreground relative z-10">
        <a href="https://x.com/QuantumVaultLab" target="_blank" rel="noopener noreferrer" 
