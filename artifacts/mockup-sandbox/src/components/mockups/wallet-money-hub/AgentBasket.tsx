  ...
  return (
    <div className="dark min-h-screen bg-background text-foreground font-sans antialiased pb-16">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-6">
        ...
        {/* Two-account split — collateral lives INSIDE the Trading Agent side */}
        <Card className="border-border bg-card overflow-hidden">
          <CardContent className="p-0">
            <div className="grid lg:grid-cols-5">
              {/* Your Wallet — compact source column */}
              <div className="lg:col-span-2 p-6 space-y-4">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Your Phantom wallet</p>
                  </div>
                </div>
              ...
              {/* Trading Agent — holds the multi-asset collateral basket */}
              <div className="lg:col-span-3 p-6 space-y-5 bg-primary/5 border-t lg:border-t-0 lg:border-l border-border">
                ...
                <div className="flex items-end justify-between gap-4">
                  <div>
                    ...
                    <div className="text-3xl font-semibold tabular-nums text-primary leading-tight mt-0.5">$8,640</div>
                  </div>
                  <div className="text-right">
                    <div className="text-xs text-muted-foreground flex items-center gap-1 justify-end">
                      <TrendingUp className="w-3.5 h-3.5 text-accent" /> Borrowing power
                    </div>
                    <div className="text-lg font-semibold tabular-nums text-accent mt-0.5">$5,180</div>
                  </div>
                </div>

                {/* One clean segmented bar instead of 5 noisy rows */}
                ...
                <div className="flex items-center justify-between rounded-xl border border-orange-500/20 bg-orange-500/5 px-4 py-3">
                  <div className="flex items-center gap-2 text-sm text-orange-300">
                    <Fuel className="w-4 h-4" /> Gas reserve (SOL)
                  </div>
                  <div className="text-lg font-semibold tabular-nums text-orange-300">0.42</div>
                </div>
              </div>
            </div>
          </CardContent>
