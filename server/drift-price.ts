const COINGECKO_IDS: Record<string, string> = {
  ...
  'TAO-PERP': 'bittensor',
  'DRIFT-PERP': 'drift-protocol',
  'POPCAT-PERP': 'popcat',
  'HYPE-PERP': 'hyperliquid',
  'TRUMP-PERP': 'official-trump',
  'AI16Z-PERP': 'ai16z',
  'FARTCOIN-PERP': 'fartcoin',
  'IP-PERP': 'story-protocol',
  'KAITO-PERP': 'kaito',
  'RLB-PERP': 'rollbit-coin',
  'DYM-PERP': 'dymension',
  '1KWEN-PERP': 'wen-4',
  'MOTHER-PERP': 'mother-iggy',
  'MOODENG-PERP': 'moo-deng',
  'DBR-PERP': 'debridge',
  '1KMEW-PERP': 'cat-in-a-dogs-world',
  'GOAT-PERP': 'goatseus-maximus',
  'PNUT-PERP': 'peanut-the-squirrel',
  'MELANIA-PERP': 'melania-meme',
  'LAUNCHCOIN-PERP': 'believe-in-something',
  'PUMP-PERP': 'pump-fun',
  'KMNO-PERP': 'kamino',
  'TNSR-PERP': 'tensor',
  'IO-PERP': 'io-net',
  ...
  'MICHI-PERP': 'michi',
  'FWOG-PERP': 'fwog',
  'ASTER-PERP': 'aster-defi',
  'ZEX-PERP': 'zeta-markets',
  'XPL-PERP': 'xpl',
  '2Z-PERP': '2z',
  '1KPUMP-PERP': 'pump-fun',
  'MET-PERP': 'metaplex',
  '1KMON-PERP': 'mon-protocol',
  'LIT-PERP': 'litentry',
};
