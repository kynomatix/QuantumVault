...
const MARKET_METADATA: Record<string, MarketMetadata> = {
  ...
  'APT-PERP': { symbol: 'APT-PERP', fullName: 'Aptos', marketIndex: 3, category: ['L1', 'Infra'], baseAssetSymbol: 'APT', isActive: true, maxLeverage: 10, minOrderSize: 0.1 },
  '1MBONK-PERP': { symbol: '1MBONK-PERP', fullName: 'Bonk', marketIndex: 4, category: ['Meme', 'Dog'], baseAssetSymbol: '1MBONK', isActive: true, maxLeverage: 10, minOrderSize: 100, warning: 'High volatility meme token' },
  'POL-PERP': { symbol: 'POL-PERP', fullName: 'Polygon', marketIndex: 5, category: ['L2', 'Infra'], baseAssetSymbol: 'POL', isActive: true, maxLeverage: 10, minOrderSize: 10 },
  'ARB-PERP': { symbol: 'ARB-PERP', fullName: 'Arbitrum', marketIndex: 6, category: ['L2', 'Infra'], baseAssetSymbol: 'ARB', isActive: true, maxLeverage: 10, minOrderSize: 1 },
  'DOGE-PERP': { symbol: 'DOGE-PERP', fullName: 'Dogecoin', marketIndex: 7, category: ['Meme', 'Dog'], baseAssetSymbol: 'DOGE', isActive: true, maxLeverage: 10, minOrderSize: 10 },
  ...
  '1MPEPE-PERP': { symbol: '1MPEPE-PERP', fullName: 'Pepe', marketIndex: 10, category: ['Meme'], baseAssetSymbol: '1MPEPE', isActive: true, maxLeverage: 4, minOrderSize: 100, warning: 'High volatility meme token' },
  'OP-PERP': { symbol: 'OP-PERP', fullName: 'Optimism', marketIndex: 11, category: ['L2', 'Infra'], baseAssetSymbol: 'OP', isActive: true, maxLeverage: 10, minOrderSize: 1 },
  'RENDER-PERP': { symbol: 'RENDER-PERP', fullName: 'Render', marketIndex: 12, category: ['AI', 'GPU'], baseAssetSymbol: 'RENDER', isActive: true, maxLeverage: 10, minOrderSize: 0.1 },
  'XRP-PERP': { symbol: 'XRP-PERP', fullName: 'XRP', marketIndex: 13, category: ['L1', 'Payment'], baseAssetSymbol: 'XRP', isActive: true, maxLeverage: 20, minOrderSize: 1 },
  'HNT-PERP': { symbol: 'HNT-PERP', fullName: 'Helium', marketIndex: 14, category: ['IoT', 'Infra'], baseAssetSymbol: 'HNT', isActive: true, maxLeverage: 5, minOrderSize: 0.1 },
  'INJ-PERP': { symbol: 'INJ-PERP', fullName: 'Injective', marketIndex: 15, category: ['L1', 'DeFi'], baseAssetSymbol: 'INJ', isActive: true, maxLeverage: 10, minOrderSize: 0.1 },
  'LINK-PERP': { symbol: 'LINK-PERP', fullName: 'Chainlink', marketIndex: 16, category: ['Oracle', 'DeFi'], baseAssetSymbol: 'LINK', isActive: true, maxLeverage: 10, minOrderSize: 0.1 },
  'RLB-PERP': { symbol: 'RLB-PERP', fullName: 'Rollbit', marketIndex: 17, category: ['Gaming'], baseAssetSymbol: 'RLB', isActive: true, maxLeverage: 5, minOrderSize: 100 },
  'PYTH-PERP': { symbol: 'PYTH-PERP', fullName: 'Pyth Network', marketIndex: 18, category: ['Oracle', 'Solana'], baseAssetSymbol: 'PYTH', isActive: true, maxLeverage: 10, minOrderSize: 1 },
  'TIA-PERP': { symbol: 'TIA-PERP', fullName: 'Celestia', marketIndex: 19, category: ['L1', 'Modular'], baseAssetSymbol: 'TIA', isActive: true, maxLeverage: 10, minOrderSize: 0.1 },
  'JTO-PERP': { symbol: 'JTO-PERP', fullName: 'Jito', marketIndex: 20, category: ['DeFi', 'Solana'], baseAssetSymbol: 'JTO', isActive: true, maxLeverage: 10, minOrderSize: 1 },
  'SEI-PERP': { symbol: 'SEI-PERP', fullName: 'Sei', marketIndex: 21, category: ['L1', 'Trading'], baseAssetSymbol: 'SEI', isActive: true, maxLeverage: 10, minOrderSize: 1 },
  ...
  'WIF-PERP': { symbol: 'WIF-PERP', fullName: 'dogwifhat', marketIndex: 23, category: ['Meme', 'Dog'], baseAssetSymbol: 'WIF', isActive: true, maxLeverage: 10, minOrderSize: 1 },
  'JUP-PERP': { symbol: 'JUP-PERP', fullName: 'Jupiter', marketIndex: 24, category: ['DeFi', 'Solana'], baseAssetSymbol: 'JUP', isActive: true, maxLeverage: 10, minOrderSize: 1 },
  ...
  'W-PERP': { symbol: 'W-PERP', fullName: 'Wormhole', marketIndex: 27, category: ['Bridge', 'Infra'], baseAssetSymbol: 'W', isActive: true, maxLeverage: 5, minOrderSize: 1 },
  'KMNO-PERP': { symbol: 'KMNO-PERP', fullName: 'Kamino', marketIndex: 28, category: ['DeFi', 'Solana'], baseAssetSymbol: 'KMNO', isActive: true, maxLeverage: 3, minOrderSize: 1 },
  'TNSR-PERP': { symbol: 'TNSR-PERP', fullName: 'Tensor', marketIndex: 29, category: ['NFT', 'Solana'], baseAssetSymbol: 'TNSR', isActive: true, maxLeverage: 5, minOrderSize: 1 },
  'DRIFT-PERP': { symbol: 'DRIFT-PERP', fullName: 'Drift Protocol', marketIndex: 30, category: ['DeFi', 'Solana'], baseAssetSymbol: 'DRIFT', isActive: true, maxLeverage: 5, minOrderSize: 1 },
  'CLOUD-PERP': { symbol: 'CLOUD-PERP', fullName: 'Cloud', marketIndex: 31, category: ['Infra'], baseAssetSymbol: 'CLOUD', isActive: true, maxLeverage: 3, minOrderSize: 10 },
  ...
  'ZEX-PERP': { symbol: 'ZEX-PERP', fullName: 'Zeta', marketIndex: 33, category: ['DeFi', 'Solana'], baseAssetSymbol: 'ZEX', isActive: true, maxLeverage: 5, minOrderSize: 10 },
  ...
  '1KWEN-PERP': { symbol: '1KWEN-PERP', fullName: 'Wen', marketIndex: 35, category: ['Meme', 'Solana'], baseAssetSymbol: '1KWEN', isActive: true, maxLeverage: 5, minOrderSize: 10, warning: 'High volatility' },
  'TON-PERP': { symbol: 'TON-PERP', fullName: 'Toncoin', marketIndex: 36, category: ['L1'], baseAssetSymbol: 'TON', isActive: true, maxLeverage: 10, minOrderSize: 0.1 },
  'MOTHER-PERP': { symbol: 'MOTHER-PERP', fullName: 'Mother Iggy', marketIndex: 37, category: ['Meme'], baseAssetSymbol: 'MOTHER', isActive: true, maxLeverage: 5, minOrderSize: 100, warning: 'High volatility meme token' },
  'MOODENG-PERP': { symbol: 'MOODENG-PERP', fullName: 'Moo Deng', marketIndex: 39, category: ['Meme'], baseAssetSymbol: 'MOODENG', isActive: true, maxLeverage: 5, minOrderSize: 100, warning: 'High volatility meme token' },
  'DBR-PERP': { symbol: 'DBR-PERP', fullName: 'deBridge', marketIndex: 40, category: ['Bridge', 'Infra'], baseAssetSymbol: 'DBR', isActive: true, maxLeverage: 5, minOrderSize: 10 },
  '1KMEW-PERP': { symbol: '1KMEW-PERP', fullName: 'Cat in a Dog World', marketIndex: 41, category: ['Meme'], baseAssetSymbol: '1KMEW', isActive: true, maxLeverage: 5, minOrderSize: 10, warning: 'High volatility meme token' },
  'MICHI-PERP': { symbol: 'MICHI-PERP', fullName: 'Michi', marketIndex: 42, category: ['Meme'], baseAssetSymbol: 'MICHI', isActive: true, maxLeverage: 5, minOrderSize: 100, warning: 'High volatility meme token' },
  ...
  'FWOG-PERP': { symbol: 'FWOG-PERP', fullName: 'Fwog', marketIndex: 44, category: ['Meme'], baseAssetSymbol: 'FWOG', isActive: true, maxLeverage: 5, minOrderSize: 100, warning: 'High volatility meme token' },
  'PNUT-PERP': { symbol: 'PNUT-PERP', fullName: 'Peanut', marketIndex: 45, category: ['Meme'], baseAssetSymbol: 'PNUT', isActive: true, maxLeverage: 5, minOrderSize: 10, warning: 'High volatility meme token' },
  'RAY-PERP': { symbol: 'RAY-PERP', fullName: 'Raydium', marketIndex: 46, category: ['DeFi', 'Solana'], baseAssetSymbol: 'RAY', isActive: true, maxLeverage: 5, minOrderSize: 0.1 },
  'HYPE-PERP': { symbol: 'HYPE-PERP', fullName: 'Hyperliquid', marketIndex: 47, category: ['DeFi', 'L1'], baseAssetSymbol: 'HYPE', isActive: true, maxLeverage: 10, minOrderSize: 0.1 },
  'LTC-PERP': { symbol: 'LTC-PERP', fullName: 'Litecoin', marketIndex: 48, category: ['L1', 'Payment'], baseAssetSymbol: 'LTC', isActive: true, maxLeverage: 10, minOrderSize: 0.01 },
  ...
  'AI16Z-PERP': { symbol: 'AI16Z-PERP', fullName: 'ai16z', marketIndex: 51, category: ['AI', 'Meme'], baseAssetSymbol: 'AI16Z', isActive: true, maxLeverage: 5, minOrderSize: 10, warning: 'High volatility' },
  'TRUMP-PERP': { symbol: 'TRUMP-PERP', fullName: 'Trump', marketIndex: 52, category: ['Meme', 'Politics'], baseAssetSymbol: 'TRUMP', isActive: true, maxLeverage: 10, minOrderSize: 1, warning: 'High volatility meme token' },
  'MELANIA-PERP': { symbol: 'MELANIA-PERP', fullName: 'Melania', marketIndex: 53, category: ['Meme', 'Politics'], baseAssetSymbol: 'MELANIA', isActive: true, maxLeverage: 5, minOrderSize: 10, warning: 'High volatility meme token' },
  ...
  'KAITO-PERP': { symbol: 'KAITO-PERP', fullName: 'Kaito', marketIndex: 55, category: ['AI'], baseAssetSymbol: 'KAITO', isActive: true, maxLeverage: 5, minOrderSize: 1 },
  ...
  'ADA-PERP': { symbol: 'ADA-PERP', fullName: 'Cardano', marketIndex: 58, category: ['L1'], baseAssetSymbol: 'ADA', isActive: true, maxLeverage: 10, minOrderSize: 10 },
  ...
  'ASTER-PERP': { symbol: 'ASTER-PERP', fullName: 'Aster', marketIndex: 62, category: ['L1'], baseAssetSymbol: 'ASTER', isActive: true, maxLeverage: 10, minOrderSize: 1 },
  ...
  '1KPUMP-PERP': { symbol: '1KPUMP-PERP', fullName: 'Pump', marketIndex: 66, category: ['Meme', 'Solana'], baseAssetSymbol: '1KPUMP', isActive: true, maxLeverage: 5, minOrderSize: 10, warning: 'High volatility' },
