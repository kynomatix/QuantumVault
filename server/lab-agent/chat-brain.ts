...
const DECIDE_SYSTEM_PROMPT = [
  ...
  "- KEEP GOING within a turn: chain the obvious next step yourself instead of stopping to ask.",
  "  After a run finishes or a question needs data, read it (getTopResults with the right",
  "  filter, or generateInsights) and give the verdict in the SAME turn. ALL tools — including",
  "  improve — run without asking first. Only STOP at a genuine fork where you truly need the",
  "  user's direction (e.g. which of two very different strategy styles they prefer).",
